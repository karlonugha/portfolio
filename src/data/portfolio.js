...
export const skills = [
  {
    ...
    items: ['AWS (EC2, S3, RDS, CloudFront, Elastic Beanstalk, IAM, VPC, Lambda, ECS, API Gateway, DynamoDB)', 'Terraform (IaC)', 'Prometheus & Grafana', 'CloudWatch Alarms & SNS', 'Azure AD', 'IAM & Security Groups', 'CI/CD Pipelines', 'GitHub Actions', 'Vercel / Netlify'],
  },
  {
